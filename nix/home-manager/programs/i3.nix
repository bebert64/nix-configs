  ...
  config =
    ...
    in
    {
      ...
      startup = [
        ...
        {
          command = "autorandr --change --force && wallpapers-manager cron --minutes 60 --mode fifty-fifty";
          always = true;
        }
        { command = "mount-NAS"; }
        ...
        {
          command = "xidlehook --timer ${toString (10 * 60)} 'lock-conky' ' ' &";
          notification = false;
        }
        {
          command = "conky -c /home/romain/nix-configs/dotfiles/conky/qclocktwo -d";
          notification = false;
        }
      ];
      ...
      modes = {
        ...
        ${music_mode} = {
          ...
          "Left" = "exec playerctl -a position 10-";
          "Right" = "exec playerctl -a position 10+";
          "Up" = "exec playerctl -a volume 0.1+";
          "Down" = "exec playerctl -a volume 0.1-";

          "space" = "exec playerctl -a play-pause, mode default";
